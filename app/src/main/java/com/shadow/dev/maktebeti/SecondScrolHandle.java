...
public class SecondScrolHandle extends RelativeLayout implements ScrollHandle {
    ...
    public SecondScrolHandle(Context context) {
        this(context, false);
    }

    public SecondScrolHandle(Context context, boolean inverted) {
        super(context);
    ...
    public void setupLayout(PDFView pdfView) {
        ...
        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = context.getResources().getDrawable(R.drawable.custom_scroll_handle_left);
            } else { // right
                align = ALIGN_PARENT_RIGHT;
                background = context.getResources().getDrawable(R.drawable.custom_scroll_handle_right);
            }
        } else {
            width = HANDLE_SHORT;
            height = HANDLE_LONG;
            if (inverted) { // top
                ...
                background = context.getResources().getDrawable(R.drawable.default_scroll_handle_top);
            } else { // bottom
                align = ALIGN_PARENT_BOTTOM;
                background = context.getResources().getDrawable(R.drawable.default_scroll_handle_bottom);
            }
        }
